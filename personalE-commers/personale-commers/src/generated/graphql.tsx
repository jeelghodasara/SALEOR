...
export type HomePageProductsQuery = { __typename?: 'Query', shop: { __typename?: 'Shop', description?: Maybe<string>, name: string }, categories?: Maybe<{ __typename?: 'CategoryCountableConnection', edges: Array<{ __typename?: 'CategoryCountableEdge', node: { __typename?: 'Category', id: string, name: string, slug: string, backgroundImage?: Maybe<{ __typename?: 'Image', url: string }> } }> }> };

export type LatestProductsQueryVariables = Exact<{ [key: string]: never; }>;


export type LatestProductsQuery = { __typename?: 'Query', products?: Maybe<{ __typename?: 'ProductCountableConnection', edges: Array<{ __typename?: 'ProductCountableEdge', node: { __typename?: 'Product', id: string, name: string, description?: Maybe<any>, thumbnail?: Maybe<{ __typename?: 'Image', url: string }> } }> }> };


export const HomePageProductsDocument = gql`
...
/**
 * __useHomePageProductsQuery__
 *
 * To run a query within a React component, call `useHomePageProductsQuery` and pass it any options that fit your needs.
 * When your component renders, `useHomePageProductsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useHomePageProductsQuery({
 *   variables: {
 *   },
 * });
 */
export function useHomePageProductsQuery(baseOptions?: Apollo.QueryHookOptions<HomePageProductsQuery, HomePageProductsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<HomePageProductsQuery, HomePageProductsQueryVariables>(HomePageProductsDocument, options);
      }
export function useHomePageProductsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<HomePageProductsQuery, HomePageProductsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<HomePageProductsQuery, HomePageProductsQueryVariables>(HomePageProductsDocument, options);
        }
export type HomePageProductsQueryHookResult = ReturnType<typeof useHomePageProductsQuery>;
export type HomePageProductsLazyQueryHookResult = ReturnType<typeof useHomePageProductsLazyQuery>;
export type HomePageProductsQueryResult = Apollo.QueryResult<HomePageProductsQuery, HomePageProductsQueryVariables>;
